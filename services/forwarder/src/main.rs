...
// The remaining sub-module symbols are only referenced in the test module.
// Marking them #[cfg(test)] suppresses "unused import" warnings in non-test builds.
#[cfg(test)]
use reader_task::{
    DownloadStallOutcome, JournalAppendError, append_read_to_journal,
    download_progress_advanced_or_started, fail_active_download, mark_reader_disconnected,

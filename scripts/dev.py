...
def build_rust(skip_build: bool, *, tauri: bool = False) -> None:
    ...
    if tauri:
        ...
        # `cargo build -p receiver` already outputs target/debug/receiver(.exe); that path is
        # what tauri-plugin-shell `sidecar("receiver")` uses (same layout as NSIS). No extra copy.
